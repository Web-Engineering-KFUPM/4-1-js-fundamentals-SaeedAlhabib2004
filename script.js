...
const SCHOOL="MyCollege";
// SCHOOL="MyCollege1", The reassignment fails because Constants cannot be changed after they are initialized
...
// write code here 
console.log("2" + 3); // concatenates because since one of them is a string Javascript makes both values strings.
console.log(2 + "3"); //  concatenates because since one of them is a string Javascript makes both values strings.
console.log(2 + 3);    
...
console.log("Sum of all numbers from 1-10 =", total);
...
console.log("var a =", a); // Var types can be accessed 
// console.log("let b =", b); // Let cannot be accessed outside the block
